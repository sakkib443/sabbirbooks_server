...
import { BookCopyRoutes } from './app/modules/bookCopy/bookCopy.routes';
import { BookCouponRoutes } from './app/modules/bookCoupon/bookCoupon.route';
...
app.use('/api/book-coupons', BookCouponRoutes);
